...
function loadVotes() {
    fetch("https://kim.up.railway.app/api/votes", {
        method: "GET",
        headers: {
...
function togglePublic(voteId, btn) {
    fetch(`https://kim.up.railway.app/api/votes/${voteId}/toggle-public`, {
        method: "PATCH",
        headers: {
            "Authorization": "Bearer " + accessToken
        }
...
function moveToTrash(voteId) {
    ...
    fetch(`https://kim.up.railway.app/api/votes/${voteId}/trash`, {
        method: "PATCH",
        headers: {
            "Authorization": "Bearer " + accessToken
        }
